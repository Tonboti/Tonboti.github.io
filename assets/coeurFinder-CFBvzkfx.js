 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fn="type.googleapis.com/google.protobuf.Int64Value",kn="type.googleapis.com/google.protobuf.UInt64Value";function pr(e,t){const r={};for(const s in e)e.hasOwnProperty(s)&&(r[s]=t(e[s]));return r}function Me(e){if(e==null)return null;if(e instanceof Number&&(e=e.valueOf()),typeof e=="number"&&isFinite(e)||e===!0||e===!1||Object.prototype.toString.call(e)==="[object String]")return e;if(e instanceof Date)return e.toISOString();if(Array.isArray(e))return e.map(t=>Me(t));if(typeof e=="function"||typeof e=="object")return pr(e,t=>Me(t));throw new Error("Data cannot be encoded in JSON: "+e)}function ge(e){if(e==null)return e;if(e["@type"])switch(e["@type"]){case Fn:case kn:{const t=Number(e.value);if(isNaN(t))throw new Error("Data cannot be decoded from JSON: "+e);return t}default:throw new Error("Data cannot be decoded from JSON: "+e)}return Array.isArray(e)?e.map(t=>ge(t)):typeof e=="function"||typeof e=="object"?pr(e,t=>ge(t)):e}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qt={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class H extends ye{constructor(t,r,s){super(`${dt}/${t}`,r||""),this.details=s,Object.setPrototypeOf(this,H.prototype)}}function Nn(e){if(e>=200&&e<300)return"ok";switch(e){case 0:return"internal";case 400:return"invalid-argument";case 401:return"unauthenticated";case 403:return"permission-denied";case 404:return"not-found";case 409:return"aborted";case 429:return"resource-exhausted";case 499:return"cancelled";case 500:return"internal";case 501:return"unimplemented";case 503:return"unavailable";case 504:return"deadline-exceeded"}return"unknown"}function Re(e,t){let r=Nn(e),s=r,n;try{const a=t&&t.error;if(a){const c=a.status;if(typeof c=="string"){if(!qt[c])return new H("internal","internal");r=qt[c],s=c}const l=a.message;typeof l=="string"&&(s=l),n=a.details,n!==void 0&&(n=ge(n))}}catch{}return r==="ok"?null:new H(r,s,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
