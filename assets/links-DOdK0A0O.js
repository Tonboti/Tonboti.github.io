const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/github-svgrepo-BwJdiq9o.js","assets/index-CR3l_Qu2.js","assets/index-_RgSnJRL.css","assets/linkedin-04rWuR2Z.js"])))=>i.map(i=>d[i]);
import{u as l,r as o,j as e,_ as a}from"./index-CR3l_Qu2.js";const i=o.lazy(()=>a(()=>import("./github-svgrepo-BwJdiq9o.js"),__vite__mapDeps([0,1,2]))),c=o.lazy(()=>a(()=>import("./linkedin-04rWuR2Z.js"),__vite__mapDeps([3,1,2])));function d(t){window.open(t,"_blank").focus()}const p=({href:t,children:r,Icon:n})=>e.jsxs("button",{className:`left-0 flex items-center justify-center w-full  md:gap-1 gap-0.25 \r
